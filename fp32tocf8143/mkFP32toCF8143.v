...
//
// On Mon Dec 11 13:48:31 IST 2023
//
//
// Ports:
// Name                         I/O  size props
...
module mkFP32toCF8143(CLK,
  ...
  wire [7 : 0] x__h772, x__h799, x__h863, x__h867, y__h718, y__h746;
  wire [1 : 0] x__h384;
  ...
  // register cf16op
  assign cf16op$D_IN = { sb_o[0], exp_o[3:0], m_o } ;
  ...
  // remaining internal signals
  assign exp_i_6_ULE_0b10001110_MINUS_bias_7_1___d22 = exp_i <= y__h746 ;
  assign exp_i_6_ULT_0b10000000_MINUS_bias_7_8___d19 = exp_i < y__h718 ;
  assign x__h384 = { 1'd0, fp32inp[31] } ;
  assign x__h772 = 8'b10000000 - exp_i ;
  assign x__h799 = 8'b10001110 - exp_i ;
  assign x__h863 = x__h867 + bias ;
  assign x__h867 = exp_i - 8'b01111111 ;
  assign y__h718 = 8'b10000000 - bias ;
  assign y__h746 = 8'b10001110 - bias ;
